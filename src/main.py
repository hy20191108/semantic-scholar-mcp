...
from core.container import configure_services, get_current_scope, set_current_scope
from core.abstractions import ILogger, IMetricsCollector
from core.logging import LoggingMiddleware
from core.metrics import MetricsMiddleware, HealthCheck
...
class SemanticScholarMCPServer:
    ...
    def __init__(self, environment: Optional[str] = None) -> None:
        ...
        self.api_client: Optional[EnhancedSemanticScholarClient] = None
